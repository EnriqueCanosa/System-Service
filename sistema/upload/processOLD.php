...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["arquivo"]) && $_FILES["arquivo"]["error"] == 0) {
        ...
        foreach ($rows as $linha) {
            ...
            $query_usuario =
            "INSERT INTO Infos 
            ( ident, codigo, fornecedor, composicao, gramatura, largura, desenho, preco, data_registrobr, nome, nome_empresa, qr_link, img_qr, img_ft) 
            VALUES 
            (:ident,:codigo,:fornecedor,:composicao,:gramatura,:largura,:desenho,:preco,:data_registrobr,:nome,:nome_empresa,:qr_link,:img_qr,:img_ft)";
            ...
            $cad_usuario->bindValue(':preco', ($linha[7] ?? ""));
